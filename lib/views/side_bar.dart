...
import 'package:blue_clay_rally/views/load_session.dart';
...
class SideBar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final scrSize = screen.sizeClass == SizeClass.compact ? 10.0 : 20.0;
        ...
        child: Column(
          children: [
                ...
                ref
                    ...
                    .update(
                      tp == null
                          ? null
                          : GpsPacket(
                              tp: TrackPoint(DateTime.now(), tp.gps, tp.alt),
                              index: null,
                            ),
                    );
                ...
                DarkTextButton(
                  ...
                  onPressed: () => {
                    showModalBottomSheet(
                      ...
                      builder: (_) =>
                          const SizedBox(height: 500, child: LoadSessionPage()),
                    ),
                  },
                ),
                Spacer(),
                          ...
                          LightIconButton(
                            ...
                            onPressed: () async {
                              await ref
                                  .read(appNotifierProvider.notifier)
                                  .finish();
                              ref.read(finishProvider.notifier).state = true;
                            },
            ...
            SizedBox(
              height: 100,
              child: () {
                final devs = ref.watch(deviceProvider);
                return ListView.builder(
                  padding: EdgeInsets.zero,
                  itemCount: devs.length,
                  itemBuilder: (_, i) => BleDeviceDisplay(i: i, b: devs[i]),
                );
              }(),
            ),
            // -------
